...
<html lang="en">
  ...
  <body>
          ...
          <div class="modal-body bg-wakwak">
            <div class="row justify-content-center text-center h-100">
              <div class="col-md-6 col-12 my-md-auto mt-3">
                <img src="img/img3.jpg" alt="" width="230px" class="rounded-pill shadow-lg" />
              </div>
              <div class="col-md-6 col-12 my-md-auto">
                The Wedding Of
                <h1 class="font-dancing fs-60">Ari & Velina</h1>
                <p>Sabtu, 19 November 2022</p>
    ...
    <header class="bg-wakwak">
      <div class="d-flex justify-content-center vh-100" style="background-image: url(img/img7.png); background-size: cover">
      ...
      <div class="container py-5">
        <div class="row text-center justify-content-center">
          ...
          <div class="col-md-5 col-12 my-md-4 my-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="500">
            <img src="img/img8.jpg" class="rounded-circle shadow-lg border-white mb-3" alt="" width="200px" />
            <h1 class="font-dancing text-dark fs-45">Ari Krismunandar</h1>
            <p class="m-0 p-0">Putra Pertama</p>
            <p class="m-0 p-0">Bapak Drajat & Ibu Dessie</p>
          </div>
          ...
          <div class="col-md-5 col-12 my-md-4 my-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1100">
            <img src="img/img9.jpg" class="rounded-circle shadow-lg border-white mb-3" alt="" width="200px" />
            <h1 class="font-dancing text-dark fs-45">Velina Ira Fauziyah</h1>
            <p class="m-0 p-0">Putri Pertama</p>
            <p class="m-0 p-0">Bapak Said & Umi Rizki</p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row text-center justify-content-center">
          ...
          <div class="col-md-6 col-12 py-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="500">
            <div class="card p-3 shadow bg-fee">
              ...
              <p class="fw-bold p-0 m-0">Sabtu, 19 November 2022</p>
          ...
          <div class="col-md-6 col-12 py-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="750">
            <div class="card p-3 shadow bg-fee">
              ...
              <p class="fw-bold p-0 m-0">Sabtu, 19 November 2022</p>
              <p class="m-0 p-0">Pukul 10.00 WIB</p>
              <p class="m-0 p-0">Jawa Barat, Indonesia</p>
            </div>
          </div>
          <div class="col-12 py-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1000">
            ...
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3966.126522609402!2d107.0390022!3d-6.2470534!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e698ef6df1d1413%3A0xa8943653e1e3f750!2sBabeh%20Mulyadi!5e0!3m2!1sid!2sid!4v1664037075007!5m2!1sid!2sid"
              width="100%"
              height="400px"
              style="border: 0"
              allowfullscreen=""
              ...
              class="shadow rounded-3 mb-3"
            ></iframe>
            <a href="https://goo.gl/maps/pp6iA5fSEJddtg4GA" target="_blank" class="text-decoration-none btn btn-light btn-outline-secondary mb-3 rounded-4">
        ...
        <div class="row text-center text-white">
          ...
          <div class="col-12" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="800">
            <div class="owl-carousel owl-theme">
              ...
              <div class="item"><img src="img/img6.jpg" /></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row text-center justify-content-center">
          ...
          <div class="col-md-6 mb-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1000">
            <div class="card bg-fee rounded-3 shadow p-3">
              ...
              <hr />
              <p>No. Rekening : <input type="text" value="123456789" class="bg-fee norek" id="rek1" readonly /></p>
              <p>A/n Me</p>
              <div>
          ...
          <div class="col-md-6 mb-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1500">
            <div class="card bg-fee rounded-3 shadow p-3">
              <img src="img/BANK_BRI_logo.svg" height="50px" alt="" class="mx-auto" />
              <hr />
              <p>No. Rekening : <input type="text" value="987654321" class="bg-fee norek" id="rek2" readonly /></p>
              <p>A/n You</p>
              <div>
          ...
          <div class="col-md-10 col-12 mx-2" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="2500">
            <div class="card bg-fee rounded-3 p-3">
              <form action="proses.php" method="post">
                ...
                <div class="mb-3">
                  <textarea name="pesan" placeholder="Ucapan" rows="4" class="form-control" required></textarea>
                </div>
                <div class="mb-3">
                  <select name="pesan" class="form-select" required>
        ...
        <div class="row text-center justify-content-center">
          <div class="col-lg-9 col-md-11 col-12">
            <div data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1000">
              <img src="img/img10.jpg" class="rounded-circle shadow-lg border-white mb-3" alt="" width="200px" />
            ...
            <div data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1250">
              <h1 class="font-dancing fs-60">Ari</h1>
              <h1 class="font-dancing fs-60">&</h1>
              <h1 class="font-dancing fs-60">Velina</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container pb-5">
        <div class="row text-center">
          <div class="col-12">
            ...
            <p class="p-0 m-0">Copyright Geekz | 2022</p>
          </div>
        </div>
      </div>
    </footer>
